...
export class MovieComponent implements OnInit {
  movies = [
    ...
    },
    {
      ...
      "overview": "Two storms separated by 25 years. A woman murdered. A daughter missed. Only 72 hours to discover the truth.",
    ...
    },
    {
      ...
      "overview": "When a young boy turns up dead in a sleepy Pennsylvania town, a local sanitation truck driver, Donald, plays detective, embarking on a precarious and obsessive investigation to prove the boy was murdered.",
      "release_date": 1555030800,
      "genres": [],
      cast: [
        "Andrew Scott",
    ...
    },
    {
      ...
      "overview": "Young lawyer Ruth Bader Ginsburg teams with her husband Marty to bring a groundbreaking case before the U.S. Court of Appeals and overturn a century of sex discrimination.",
      "release_date": 1545696000,
      "genres": [
        "Drama",
        "History"
  ...
  @Output() peoplecast: EventEmitter<any> = new EventEmitter();
  ...
  @Input() i: any
  @Input() movie!: Movie
  // @Output() indexGet: EventEmitter<Movie> = new EventEmitter();
  ...
  movieCast: any
  mn: any
  moviesGenres = this.movies;
  constructor() {
    this.movieID = localStorage.getItem("MovieID");
    console.log(this.movieID);
    this.movieCast = JSON.parse(localStorage.getItem("Cast") || "")
    this.movieGenre = JSON.parse(localStorage.getItem("MovieGenre") || "")
    console.log(this.movieGenre);
    this.mm = localStorage.getItem("Genre")
    this.mn = this.movies[0].genres
  ...
  ngOnInit(): void {
    this.movieShow = this.movies.filter(movie => movie.id == this.movieID)
    this.ratingDisplay = this.movieShow[0].rating
    this.moviesGenres = this.movies.filter(movie => movie.genres == this.mm)
  ...
  people(cast: any) {
    // console.log(cast);
    this.peoplecast.emit(cast)
    console.log(cast);
    localStorage.setItem("Person", cast)

  }
  indexGet(movie: Movie) {
